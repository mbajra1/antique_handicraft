...
class DiscountsControllerTest < ActionController::TestCase
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post :create, discount: { discount_amount: @discount.discount_amount, discount_code: @discount.discount_code }
    end
  ...
  test "should update discount" do
    patch :update, id: @discount, discount: { discount_amount: @discount.discount_amount, discount_code: @discount.discount_code }
    assert_redirected_to discount_path(assigns(:discount))
  end
