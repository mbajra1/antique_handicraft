...
class CartItemsControllerTest < ActionController::TestCase
  ...
  test "should create cart_item" do
    assert_difference('CartItem.count') do
      post :create, cart_item: { price: @cart_item.price, product_id: @cart_item.product_id, quantity: @cart_item.quantity, seller_id: @cart_item.seller_id, shopping_cart_id: @cart_item.shopping_cart_id }
    end
  ...
  test "should update cart_item" do
    patch :update, id: @cart_item, cart_item: { price: @cart_item.price, product_id: @cart_item.product_id, quantity: @cart_item.quantity, seller_id: @cart_item.seller_id, shopping_cart_id: @cart_item.shopping_cart_id }
    assert_redirected_to cart_item_path(assigns(:cart_item))
  end
